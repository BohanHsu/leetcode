...
require '../remove_duplicates_from_sorted_list_ii.rb'
...
describe 'delete_duplicates' do
  it 'should pass test 1' do
    list_to_array(delete_duplicates(array_to_list([1,2]))).must_equal([1,2])
  end
  
  it 'should pass test 2' do
    list_to_array(delete_duplicates(array_to_list([1,2,2]))).must_equal([1])
  end
  
  it 'should pass test 3' do
    list_to_array(delete_duplicates(array_to_list([1,1,2]))).must_equal([2])
  end

  it 'should pass test 4' do
    list_to_array(delete_duplicates(array_to_list([1,2,3,3,4,4,4,5]))).must_equal([1,2,5])
  end

  it 'should pass test 5' do
    list_to_array(delete_duplicates(array_to_list([1,1,1,2,3]))).must_equal([2,3])
  end
end
