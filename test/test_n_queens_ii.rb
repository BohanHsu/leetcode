...
describe 'total_n_queens' do
  it 'should work when n = 1' do
    expected_result = 1
    total_n_queens(1).must_equal(expected_result)
  end

  it 'should work when n = 2' do
    expected_result = 0
    total_n_queens(2).must_equal(expected_result)
  end

  it 'should work when n = 3' do
    expected_result = 0
    total_n_queens(3).must_equal(expected_result)
  end

  it 'should work when n = 4' do
    expected_result = 2
    total_n_queens(4).must_equal(expected_result)
  end
end
